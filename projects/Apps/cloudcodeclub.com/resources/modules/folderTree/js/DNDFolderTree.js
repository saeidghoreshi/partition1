...
function JSDragDropTree() {
    ...
    this.imageFolder = '/resources/modules/folderTree/images/';
    this.folderImage = 'control_folder.gif';
    this.plusImage = 'control_plus.gif';
    this.minusImage = 'control_minus.gif';
    this.maximumDepth = 6;
...
JSDragDropTree.prototype = {
    ...
    */
    ...
    showHideNode: function (e, inputId) {
        ...
        JSTreeObj.Set_Cookie('control_expandedNodes', initExpandedNodes, 500);
        return false;
    }
		,
    /* Initialize drag */
    ...
    createDropIndicator: function () {
        ...
        img.src = this.imageFolder + 'control_ind1.gif';
    ...
    initTree: function () {
        ...
        if (this.deleteAllowed || this.renameAllowed) {
            try {
                ...
                var menuModel = new control_menuModel();
                ...
                this.contextMenu = new control_contextMenu();
        ...
        var nodeId = 0;
        var control_tree = document.getElementById(this.idOfTree);
        var menuItems = control_tree.getElementsByTagName('LI'); // Get an array of all menu items
        for (var no = 0; no < menuItems.length; no++) {
            // No children var set ?
            ...
            //menuItems[no].id = 'control_treeNode' + nodeId;
        ...
        initExpandedNodes = this.Get_Cookie('control_expandedNodes');
