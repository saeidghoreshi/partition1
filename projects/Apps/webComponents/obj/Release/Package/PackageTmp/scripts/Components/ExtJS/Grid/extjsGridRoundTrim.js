var extjsGridRoundTrim;
(function ($) {

	extjsGridRoundTrim=cls.define(
    {
			id:null,
									...
									},
									{
										...
										listeners:
										{
											click: function () {
												...
												var rec = me.grid.getStore().findRecord("fname", "firstname-0", 0, true, false, true);
									...
									},
									{
										...
										listeners:
										{
											click: function () {
												...
												//(1)
												var rec = me.grid.getStore().getAt(0);
